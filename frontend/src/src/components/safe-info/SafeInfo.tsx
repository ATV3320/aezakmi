...
import safeLogoLight from '../../assets/safe-info-logo-light.svg'
import safeLogoDark from '../../assets/safe-info-logo-dark.svg'
            ...
            {Object.values(erc20Balances).length > 0 ? (
              <FormControl fullWidth variant="standard">
                ...
                >
                  ...
                  {Object.values(erc20Balances).map((erc20Balance:any) => (
